...
public class dummyConfig extends Robot {
...
//    private servo clawR;
    ...
    public dummyConfig(final HardwareMap h, final Op o) {
        super(h);
        opMode = o;
    }

    public dummyConfig(final HardwareMap h, final DcMotor.RunMode runMode) {
        super(h);
        motorMode = runMode;
    }
...
//    public servo clawR() { return clawR; }
    public i2csensor colorSensor() { return colorSensor; }
}